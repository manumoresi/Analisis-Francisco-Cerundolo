---
title: "Análisis Francisco Cerúndolo"
author: "Manuel Moresi - Simón Gazze"
date: "`r Sys.Date()`"
output: 
  html_document:
    theme: cerulean
...
-   Algo a tener en cuenta, es que a la hora de realizar predicciones, el modelo utiliza variables que son medidas una vez que termina el partido, por lo que no sería posible realizar estas predicciones para partidos futuros. Lo que se propone es utilizar los promedios de los últimos 5 partidos de los rivales y de Cerúndolo en estas variables y de esta manera realizar dichas predicciones.