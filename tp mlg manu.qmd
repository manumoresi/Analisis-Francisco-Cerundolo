...
library(glmtoolbox)
library(statmod)
#cerundolo_final1 <- read_excel("C:/Users/Usuario/Downloads/cerundolo_final1.xlsx")
...
g1=mosaic(
  ...
  highlighting_fill = c("purple2", "lightpink")
)
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
g2=ggplot(cerundolo_final1) +
  aes(x = fran_win, fill = tourney_level) +
  geom_bar(position = "dodge") +
  labs(x = "Resultado", y = "Frecuencia")
...
modelo_completo <- glm(fran_win ~ ., data = cerundolo_modelo, family = binomial(link = "probit"))

# Selección de variables paso a paso basada en AIC
modelo_seleccionado <- step(modelo_completo, direction = "backward")
```

Luego de una larga y detallada selección de modelo, se retienen las siguientes variables: Edad del oponente, diferencia en el ranking, porcentaje de puntos ganados con el primer servicio, porcentaje de puntos ganados del rival con el primer servicio,porcentaje de puntos ganados por el rival con el segundo servicio, porcentaje de puntos de break point ganados por Fran y la cantidad de puntos ganados en el break point por el rival

```{r}
modelo_final = glm(fran_win ~ pct_fran_1stWon + pct_opp_1stWon + pct_fran_2ndWon + 
...
modelo_logit.2 <- glm(fran_win ~ pct_fran_1stWon + pct_opp_1stWon + pct_fran_2ndWon + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins+ pred.2.logit, data=cerundolo_modelo, family=binomial(link="logit"))
...
la distribucion de la variable latente?
...
modelo_l1 =glm(fran_win ~ cat1 + pct_opp_1stWon + pct_fran_2ndWon + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))

modelo_l2=glm(fran_win ~ ord1 + pct_opp_1stWon + pct_fran_2ndWon + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))
...
modelo_l1 =glm(fran_win ~ pct_fran_1stWon + cat2 + pct_fran_2ndWon + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))

modelo_l2=glm(fran_win ~ pct_fran_1stWon + ord2 + pct_fran_2ndWon + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))
...
modelo_l1 =glm(fran_win ~ pct_fran_1stWon + pct_opp_1stWon + cat3 + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))

modelo_l2=glm(fran_win ~ pct_fran_1stWon + pct_opp_1stWon + ord3 + 
    pct_opp_2ndWon + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))
...
modelo_l1 =glm(fran_win ~ pct_fran_1stWon + pct_opp_1stWon + pct_fran_2ndWon + 
    cat4 + pct_fran_bp_wins + pct_opp_bp_wins, data=cerundolo_modelo, family=binomial(link="logit"))

modelo_l2=glm(fran_win ~ pct_fran_1stWon + pct_opp_1stWon + pct_fran_2ndWon + 
