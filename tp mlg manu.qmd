---
title: "Trabajo Práctico Modélos Lineales Generalizados: Análsis de Francisco Cerúndolo"
...
Y en la Tabla 1, se ve que tanto en polvo de ladrillo como en cesped tiene un record positivo (más victorias que derrotas), en cambio en canchas duras posee un record negativo. *A pesar de ver diferencias en las proporciones de victorias según la superficie, estas son relativamente pequeñas, por lo cual no pareciera que tenga una influencia significativa en la respuesta.*
...
$logit(\pi_i)=ln(\frac{\pi_i}{1-\pi_i})= \beta_{0}+\beta_{1}*Fran1stWon_i+\beta_{2}*Opp1stWon_i+\beta_{3}*Fran2ndWon_i+\beta_{4}*Opp2ndWon_i+$ 
$+\beta_{5}*FranBpWin+\beta_{6}*OppBpWin$
...
$logit(\pi_i)=ln(\frac{\pi_i}{1-\pi_i})= \beta_{0}+\beta_{1}*Fran1stWon_i+\beta_{2}*D_{(0.6,0.65)i}+\beta_{3}*D_{(0.65,0.7)i}+$
$+\beta_{4}*D_{(0.7,0.75)i}+\beta_{5}*D_{(0.75,Inf)i}+\beta_{6}*Fran2ndWon_i+\beta_{7}*Opp2ndWon_i+\beta_{8}*FranBpWin+\beta_{9}*OppBpWin$
...
$logit(\hat{\pi_i})=ln(\frac{\hat{\pi_i}}{1-\hat\pi_i})= -16.23+36.19*Fran1stWon_i-3.86*D_{(0.6,0.65)i}-5.63*D_{(0.65,0.7)i}-5.20*D_{(0.7,0.75)i}-$
$-12.43*D_{(0.75,Inf)i}+19.61*Fran2ndWon_i-26.49*Opp2ndWon_i+8.88*FranBpWin-7.40*OppBpWin$
